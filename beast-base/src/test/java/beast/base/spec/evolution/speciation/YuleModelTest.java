...
public class YuleModelTest  {
    ...
    public void testYule() {
        ...
        bdssm.setInputValue("birthDiffRate", new RealScalarParam<>(10, PositiveReal.INSTANCE));
        bdssm.setInputValue("originHeight", new RealScalarParam<>(10, PositiveReal.INSTANCE));

...
import beast.base.spec.evolution.substitutionmodel.*;
...
import static beast.base.spec.ParamUtils.createRealVector;
...
public class TreeLikelihoodTest  {
    ...
    private RealScalar<PositiveReal> mu1 = new RealScalarParam<>(1.0, PositiveReal.INSTANCE);

    public TreeLikelihoodTest() {
        super();
    }

    protected beast.base.spec.evolution.likelihood.TreeLikelihood newTreeLikelihood() {
    ...
    public void testJC69Likelihood() throws Exception {
        ...
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", JC);
    ...
    public double[] testJC69Likelihood(Alignment data, Tree tree) throws Exception {
        ...
        SiteModel siteModel = new SiteModel();
        RealScalar<PositiveReal> mu = new RealScalarParam<>(0.6, PositiveReal.INSTANCE);
        siteModel.initByName("mutationRate", mu, "substModel", JC);
    ...
    public void testAscertainedJC69Likelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(1.0, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", hky);
    ...
    public void testK80Likelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(27.40259, PositiveReal.INSTANCE),
                "frequencies", freqs);
    ...
    public void testHKY85Likelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(29.739445, PositiveReal.INSTANCE),
                "frequencies", freqs);
    ...
    public void testHKY85GLikelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(38.82974, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 4,
                "shape", new RealScalarParam<>(0.137064, PositiveReal.INSTANCE),
                "proportionInvariant", new RealScalarParam<>(0.0, NonNegativeReal.INSTANCE),
                "substModel", hky);
    ...
    public void testHKY85ILikelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(38.564672, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1,
                "shape", new RealScalarParam<>(0.137064, PositiveReal.INSTANCE),
                "proportionInvariant", new RealScalarParam<>(0.701211, NonNegativeReal.INSTANCE),
                "substModel", hky);
    ...
    public void testHKY85GILikelihood() throws Exception {
        ...
        HKY hky = new HKY();
        hky.initByName("kappa", new RealScalarParam<>(39.464538, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 4,
                "shape", new RealScalarParam<>(0.587649, PositiveReal.INSTANCE),
                "proportionInvariant", new RealScalarParam<>(0.486548, NonNegativeReal.INSTANCE),
                "substModel", hky);
    ...
    public void testGTRILikelihood() throws Exception {
        ...
        gsm.initByName("rates", createRealVector(12, 1.0, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1,
                "proportionInvariant", new RealScalarParam<>(0.5, NonNegativeReal.INSTANCE),
                "substModel", gsm);
    ...
    public void testGTRGLikelihood() throws Exception {
        ...
        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 4,
                "shape", new RealScalarParam<>(0.5, PositiveReal.INSTANCE),
                "substModel", gsm);
    ...
    void aminoacidModelTest(SubstitutionModel substModel, double expectedValue) throws Exception {
        ...
        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", substModel);
    ...
    void aminoacidModelTestI(SubstitutionModel substModel, double expectedValue) throws Exception {
        ...
        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", substModel,
                "proportionInvariant", new RealScalarParam<>(0.2, NonNegativeReal.INSTANCE));
    ...
    void aminoacidModelTestIG(SubstitutionModel substModel, double expectedValue) throws Exception {
        ...
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", substModel,
                ...
                "shape", new RealScalarParam<>(0.15, PositiveReal.INSTANCE),
                "proportionInvariant", new RealScalarParam<>(0.2, NonNegativeReal.INSTANCE));
    ...
    public void testSDolloLikelihood() throws Exception {
        ...
        Frequencies freqs = new Frequencies();
        freqs.initByName("frequencies", new SimplexParam(new double[]{1, 0}));

        RealScalar<PositiveReal> deathprob = new RealScalarParam<>(1.7, PositiveReal.INSTANCE);
        MutationDeathModel SDollo = new MutationDeathModel();
        SDollo.initByName("deathprob", deathprob, "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", SDollo);
    ...
    public void testBinaryCovarionLikelihood() throws Exception {
        ...
        RealScalar<PositiveReal> alpha = new RealScalarParam<>(0.284, PositiveReal.INSTANCE);
        RealVector<PositiveReal> switchRate = new RealVectorParam<>(new double[]{0.829}, PositiveReal.INSTANCE);
        Simplex frequencies = new SimplexParam(new double[]{0.683, 0.317});
        ...
        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", covarion);
    ...
    public void testMarginalisationOfLikelihoodBinary() throws Exception {
        ...
        Frequencies freqs = new Frequencies();
        freqs.initByName("frequencies", new SimplexParam(new double[]{0.683, 0.317}));
        GeneralSubstitutionModel covarion = new GeneralSubstitutionModel();
        covarion.initByName("frequencies", freqs,
                "rates", createRealVector(2, 1.0, PositiveReal.INSTANCE));
    ...
    public void testMarginalisationOfLikelihoodNucleotide() throws Exception {
        ...
        Frequencies freqs = new Frequencies();
        freqs.initByName("frequencies", new SimplexParam(new double[]{0.2, 0.3, 0.4, 0.1}));
        GeneralSubstitutionModel gsm = new GeneralSubstitutionModel();
        gsm.initByName("rates", createRealVector(12, 1.0, PositiveReal.INSTANCE),
                "frequencies", freqs);

        SiteModel siteModel = new SiteModel();
        siteModel.initByName("mutationRate", mu1, "gammaCategoryCount", 1, "substModel", gsm);

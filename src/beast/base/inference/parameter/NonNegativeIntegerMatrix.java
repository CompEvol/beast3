...
public class NonNegativeIntegerMatrix extends IntegerParameter implements Matrix<NonNegativeInt> {
	
	@Override
	public void initAndValidate() {
		super.initAndValidate();
		if (!isValid()) {
			throw new IllegalArgumentException("starting value must be a non-negative whole numbers");
		}
	}

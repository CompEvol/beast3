...
@Description("Integer valued parameter representing a single scalar value")
public class IntegerScalar extends IntegerParameter implements Scalar<Int> {

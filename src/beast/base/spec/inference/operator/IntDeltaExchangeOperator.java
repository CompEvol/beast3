...
//				if (intparameterInput.get().size() > 0) {
					weights = new int[intparameterInput.get().size()];
//				} else {
...
//        }
        ...
        int dim = -1;
//        if (compoundParameter == null) { // one parameter case
        	dim = intparameterInput.get().size();
//        } else {
...
//            RealParameter realparameter = null;
            IntVectorParam intparameter = null;

//            if (parameterInput.get().isEmpty()) {
                intparameter = intparameterInput.get();
//            } else {
...
//            }
    ...
    public final String getPerformanceSuggestion() {
        ...
        // new scale factor
        final double newDelta = (double) delta * ratio;

...
public interface Transform {
    ...
    abstract class UnivariableTransform extends BEASTObject implements Transform {
    	final public Input<List<Tensor<?,?>>> functionInput = new Input<>("f", "parameter to be transformed", new ArrayList<>());
    	
    	List<Tensor<?,?>> parameter;
 	  ...
 	  public Object myInitByName(final Object... objects) {
        ...
        public List<Tensor<?,?>> getF() {
			return parameter;
		}

		public void setParameter(Tensor<?,?> parameter) {
			if (parameter == null) {
		...
		public void setParameter(List<Tensor<?,?>> parameter) {
			if (parameter == null) {
				this.parameter = new ArrayList<>();
			}
			if (parameter != null) {
		...
		public UnivariableTransform(List<Tensor<?,?>> parameter) {
...
//            return sum;
    ...
    abstract class MultivariableTransform extends BEASTObject implements Transform {
		...
		public void setF(Tensor<?,?> parameter) {
		...
		public void setParameter(List<Tensor<?,?>> parameters) {
			if (this.parameter == null) {
				this.parameter = new ArrayList<>();
			}
			if (parameter != null) {
		...
		MultivariableTransform(List<Tensor<?,?>> parameter) {
    ...
    abstract class MultivariableTransformWithParameter extends MultivariableTransform {
    	public MultivariableTransformWithParameter(List<Tensor<?,?>> parameter) {
    		super(parameter);    		
    	}
        abstract public List<Tensor<?,?>> getF();
    }
    ...
    abstract class MultivariateTransform extends MultivariableTransform {
    	...
    	public MultivariateTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);    		
    	}
    ...
    public class LogTransform extends UnivariableTransform {
    	...
    	public LogTransform(Tensor<?,?> parameter) {
    	...
    	public LogTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
...
//        public LogConstrainedSumTransform(@Param(name="parameter",description="parameter to be transformed") List<Tensor<?,?>> parameter) {
//    		super(parameter);
//    		fixedSum = 1;
//        }
...
//		public LogConstrainedSumTransform(@Param(name="f",description="parameter to be transformed") List<Tensor<?,?>> parameter,
...
//        		@Param(name="weights",description="weight used for each dimension") double [] weights) {
		public LogConstrainedSumTransform(List<Tensor<?,?>> parameter,
        		double fixedSum,
        		double [] weights) {
    		super(parameter);
		...
		public LogConstrainedSumTransform(Tensor<?,?> parameter,
        		double fixedSum) {
...
//        		@Param(name="sum",description="total sum of parameter values the parameter is constrained to", defaultValue="1.0") double fixedSum) {
    ...
    public class LogitTransform extends UnivariableTransform {
        ...
        public LogitTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
            //range = 1.0;
            //lower = 0.0;
        }
...
//        private final double lower;
    ...
    public class FisherZTransform extends UnivariableTransform {
    	...
    	public FisherZTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
    ...
    public class NegateTransform extends UnivariableTransform {
    	...
    	public NegateTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
    ...
    public class PowerTransform extends UnivariableTransform{
    	...
    	PowerTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
            this.power = 2;
        }
...
//            return 0;
    ...
    public class NoTransform extends UnivariableTransform {
    	...
    	public NoTransform(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
...
//        }
    ...
    public class NoTransformMultivariable extends MultivariableTransform {
    	...
    	public NoTransformMultivariable(List<Tensor<?,?>> parameter) {
    		super(parameter);    		
    	}
    ...
    public class LowerBound extends UnivariableTransform {
    	...
    	public LowerBound(Tensor<?,?> parameter) {
    		myInitByName("f", parameter);
    	}

    	public LowerBound(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
    ...
    public class UpperBound extends UnivariableTransform {
    	...
    	public UpperBound(Tensor<?,?> parameter) {
    		myInitByName("f", parameter);
    	}

    	public UpperBound(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
    ...
    public class Interval extends UnivariableTransform {
    	...
    	public Interval(Tensor<?,?> parameter) {
    		myInitByName("f", parameter);
    	}

    	public Interval(List<Tensor<?,?>> parameter) {
    		super(parameter);
    	}
...
//            return outerGradient;
    ...
    public class Inverse extends UnivariableTransform {
        ...
        public Inverse(UnivariableTransform inner, List<Tensor<?,?>> parameter) {
    		super(parameter);    	
            this.inner = inner;
        }
    ...
    public class InverseMultivariate extends MultivariateTransform {
        ...
        public InverseMultivariate(MultivariateTransform inner, List<Tensor<?,?>> parameter) {
    		super(parameter);    	
            this.inner = inner;
        }
...
//        }
        ...
        public double[] updateGradientLogDensity(double[] gradient, double[] transformedValues, int from, int to) {
            ...
            assert from == 0 && to == transformedValues.length : "The transform Tensor<?,?> can only be applied to the whole array of values.";
            // gradient of log jacobian of the inverse
    ...
    public class PositiveOrdered extends MultivariateTransform {
    	...
    	public PositiveOrdered(List<Tensor<?,?>> parameter) {
    		super(parameter); 
		}
        ...
        public double[] transform(double[] values, int from, int to) {
            ...
            assert from == 0 && to == dim : "The transform Tensor<?,?> can only be applied to the whole array of values.";
    ...
    public class Array extends MultivariableTransformWithParameter {
          ...
          //private final Tensor<?,?> parameter;

          public Array(List<Transform> array, List<Tensor<?,?>> parameter) {
      		  super(parameter); 
              //this.parameter = parameter;
              this.array = array;
...
//              }
          ...
          public List<Tensor<?,?>> getF() { return parameter; }
    ...
    public class Collection extends MultivariableTransformWithParameter {
        ...
        public Collection(List<ParsedTransform> segments, List<Tensor<?,?>> parameter) {
        	super(parameter);
            // this.parameter = parameter;
...
//        }
    ...
    public class ParsedTransform {
        ...
        public List<Tensor<?,?>> parameters = null;

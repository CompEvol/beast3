        ...
        try {
            while (i < args.length) {
                ...
                if (args[i].equals("")) {
                    ...
                    // already done in beastfx.app.beauti.Beauti
                    i += 1;
...
//			if (!name.startsWith("beastfx.app.beauti")) {
...
//		}
    ...
    public void extractSequences(String xml) throws XMLParserException, SAXException, IOException, ParserConfigurationException  {
        ...
        if (beautiTemplate == null) {
            ButtonType choice = Alert.showConfirmDialog(null /*getFrame()*/, 
            		"This file does not appear to be generated by BEAUti. If you load it, unexpected behaviour may follow",
            		"Warning",
...
//                    Alert.showMessageDialog(beauti.getSelectedComponent(),

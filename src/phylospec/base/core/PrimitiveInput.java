...
//            	return;
//            } else if (value instanceof List<?> && primitiveType.isAssignableFrom(((List<?>) value).get(0).getClass())) {
...
//                        ". " + primitiveType.getName() + ".isAssignableFrom(" + value.getClass() + ")=false");
//            }
//
...
//                                    if (rawType.equals(primitiveType)) {
//                                    	this.value = (T) value;
//                                    	return;
//                                    }
//                                }
                ...
                if (fields[i].getType().isAssignableFrom(PrimitiveInput.class)) {
                    ...
                    if (input == this) {
                        ...
                        if (value != null && value instanceof List<?>) {
                            ...
                            try {
                            	primitiveType = (Primitive<?>) genericTypes2[0];
                            } catch (ClassCastException e) {
                            	// can get here with parameterised types, e.g Input<List<Parameter.Base<T>>>
                            	primitiveType = (Primitive<?>) ((ParameterizedType)genericTypes2[0]).getRawType();
                            }
